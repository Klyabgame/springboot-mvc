...
import com.franz.springboot.springmvc.app.services.UserService;
...
public class UserController {
    ...
    public String form(@PathVariable Long id, Model model, RedirectAttributes redirect){
        ...
        if(optionalUser.isPresent()) {
            ...
            redirect.addFlashAttribute("error","el usuario con el id"+ id +" no existe");
    ...
    public String delete(@PathVariable Long id, RedirectAttributes redirect){
        ...
        redirect.addFlashAttribute("error", "Error el usuario con el id" + id + "no existe");
        return "redirect:/users";
    }
